...
class Slide implements \Serializable
{
     ...
     *@Assert\Image(
     *     maxSize = "7000k",
     *     maxSizeMessage = "Poids maximal Accepté pour l'image : 7000 k",
     *     mimeTypes={"image/png", "image/jpeg", "image/jpg", "image/gif","image/apng", "image/gif", "image/webp", "image/x-ms-bmp", "image/bmp"},
